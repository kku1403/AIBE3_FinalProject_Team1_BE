...
VALUES (1, now(), now(), '', '', 'test-1@email.com', 0, 'Josephine Chand',
       ...
       (3, now(), now(), '', '', 'test-3@email.com', 0, 'Siti Ke',
        'Christine Yu', 'msRmfajw6', '01033334444', 'https://example-3.com', 'USER');
...
VALUES
    (1, 2, 2, now(), now(), '', '', '239.222.101.166', '216.149.58.145','',
        'DIRECT', '', '', now(), now(), '', 'DIRECT','', 'RENTING'),
    (2, 3, 1, now(), now(), '', '', '239.222.101.166', '216.149.58.145','',
     'DIRECT', '', '', now(), now(), '', 'DIRECT','', 'RENTING');
...
VALUES (1, now(), now(), 'comment', 3, 0, 3, 3, 1),
       (2, now(), now(), 'comment', 3, 0, 3, 3, 2);

INSERT INTO report (id, member_id, report_type, target_id, comment, created_at, modified_at)
VALUES (1, 1, 'MEMBER', 2, 'comment', now(), now()),
       (2, 2, 'MEMBER', 1, 'comment', now(), now()),
       (3, 2, 'MEMBER', 3, 'comment', now(), now()),
       (4, 1, 'POST', 1, 'comment', now(), now()),
       (5, 2, 'POST', 1, 'comment', now(), now()),
       (6, 2, 'POST', 2, 'comment', now(), now()),
       (7, 1, 'REVIEW', 1, 'comment', now(), now()),
       (8, 2, 'REVIEW', 1, 'comment', now(), now()),
       (9, 2, 'REVIEW', 2, 'comment', now(), now());